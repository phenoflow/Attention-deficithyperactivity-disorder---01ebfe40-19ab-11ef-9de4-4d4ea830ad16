...
steps:
  ...
  attention-deficithyperactivity-disorder-adhd-brain---primary:
    run: attention-deficithyperactivity-disorder-adhd-brain---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  attention-deficithyperactivity-disorder-adhd-conduct---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: attention-deficithyperactivity-disorder-adhd-brain---primary/output
